...
export const MODULES: Module[] = [
  ...
  { slug: "geo-systems", number: 30, phase: "Distributed Systems Deep", phaseNumber: 5, title: "Geospatial systems", subtitle: "Geohashing, quadtrees, S2 cells, nearest-neighbor at scale", duration: "~2–2.5h", project: "Java lab: build a geohash-based 'nearby drivers' index with O(log n) lookups", status: "available" },
