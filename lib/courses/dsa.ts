...
export const MODULES: Module[] = [
  ...
  { slug: "strings", number: 5, phase: "Linear Data Structures", phaseNumber: 2, title: "Strings & string building", subtitle: "Immutability, why + in a loop is a trap, StringBuilder, char[] tricks", duration: "~1.5–2h", project: "Anagram + palindrome lab + LeetCode: Valid Anagram, Valid Palindrome, Reverse String", status: "coming-soon" },
  { slug: "linked-lists", number: 6, phase: "Linear Data Structures", phaseNumber: 2, title: "Linked lists (singly, doubly, circular)", subtitle: "Node-and-pointer model, dummy-head trick, fast/slow pointers", duration: "~2–2.5h", project: "Implement singly + doubly linked list + LeetCode: Reverse Linked List, Middle, Cycle", status: "coming-soon" },
  { slug: "stacks", number: 7, phase: "Linear Data Structures", phaseNumber: 2, title: "Stacks", subtitle: "LIFO, the call stack analogy, monotonic stacks (preview)", duration: "~1.5–2h", project: "Bracket-matcher + RPN calculator + LeetCode: Valid Parentheses, Min Stack, Daily Temperatures", status: "coming-soon" },
  { slug: "queues", number: 8, phase: "Linear Data Structures", phaseNumber: 2, title: "Queues & deques", subtitle: "FIFO, circular buffers, ArrayDeque (the one you should actually use)", duration: "~1.5–2h", project: "Ring-buffer implementation + LeetCode: Implement Queue using Stacks, Number of Recent Calls", status: "coming-soon" },

  // Phase 3 · Hashing & Trees
  { slug: "hashmaps", number: 9, phase: "Hashing & Trees", phaseNumber: 3, title: "Hash tables & HashMap", subtitle: "Hash functions, collisions, Java's HashMap internals, why equals/hashCode matter", duration: "~2.5–3h", project: "Build a tiny HashMap from scratch + LeetCode: Two Sum, Contains Duplicate, Group Anagrams", status: "coming-soon" },
  { slug: "sets", number: 10, phase: "Hashing & Trees", phaseNumber: 3, title: "Sets & frequency counting patterns", subtitle: "HashSet vs TreeSet, the count-then-check pattern that solves a surprising number of problems", duration: "~1.5h", project: "Sliding-window character counter + LeetCode: Intersection of Two Arrays, Longest Substring Without Repeating", status: "coming-soon" },
  { slug: "trees", number: 11, phase: "Hashing & Trees", phaseNumber: 3, title: "Trees & binary trees", subtitle: "Terminology, recursive structure, preorder/inorder/postorder by hand", duration: "~2–2.5h", project: "Tree builder + traversal visualizer + LeetCode: Max Depth, Same Tree, Invert Binary Tree", status: "coming-soon" },
  { slug: "bst", number: 12, phase: "Hashing & Trees", phaseNumber: 3, title: "Binary search trees & balanced trees", subtitle: "BST invariants, why unbalanced degrades to O(n), AVL/Red-Black intuition, TreeMap", duration: "~2–2.5h", project: "BST insert/search/delete from scratch + LeetCode: Validate BST, LCA of BST", status: "coming-soon" },
  { slug: "heaps", number: 13, phase: "Hashing & Trees", phaseNumber: 3, title: "Heaps & priority queues", subtitle: "Array-backed heap mechanics, sift-up/down, the top-K pattern", duration: "~1.5–2h", project: "Build a min-heap from scratch + LeetCode: Kth Largest, Last Stone Weight, Top K Frequent", status: "coming-soon" },
