...
export const MODULES: Module[] = [
  ...
  // Phase 4 · Graphs
  { slug: "graphs-intro", number: 14, phase: "Graphs", phaseNumber: 4, title: "Graph fundamentals & representations", subtitle: "Directed/undirected, weighted/unweighted, adjacency list vs matrix", duration: "~1.5–2h", project: "Graph builder + neighbor-iterator API + LeetCode: Find if Path Exists in Graph", status: "available" },
  { slug: "bfs-dfs", number: 15, phase: "Graphs", phaseNumber: 4, title: "BFS & DFS", subtitle: "The two traversals, recursive vs iterative DFS, when BFS gives shortest path", duration: "~2.5–3h", project: "Maze solver (BFS + DFS visualized) + LeetCode: Number of Islands, Clone Graph, Rotting Oranges", status: "available" },
  { slug: "shortest-path", number: 16, phase: "Graphs", phaseNumber: 4, title: "Shortest path & topological sort", subtitle: "Dijkstra, BFS as unweighted shortest path, Kahn's algorithm, cycle detection", duration: "~2–2.5h", project: "Dijkstra on a small road-graph + LeetCode: Course Schedule I & II, Network Delay Time", status: "available" },
  ...
  { slug: "two-pointers", number: 18, phase: "Algorithmic Techniques", phaseNumber: 6, title: "Two pointers", subtitle: "Opposite-end vs same-direction, the sorted-array tell", duration: "~1.5–2h", project: "LeetCode: Two Sum II, 3Sum, Container With Most Water, Trapping Rain Water (intro)", status: "available" },
  ...
  { slug: "recursion", number: 22, phase: "Algorithmic Techniques", phaseNumber: 6, title: "Recursion & divide-and-conquer", subtitle: "The recursion contract, base-case discipline, recurrence-relation shortcut for Big-O", duration: "~2–2.5h", project: "LeetCode: Pow(x, n), Merge K Sorted Lists, Sort an Array", status: "available" },
  { slug: "backtracking", number: 23, phase: "Algorithmic Techniques", phaseNumber: 6, title: "Backtracking", subtitle: "Choose / explore / unchoose template, pruning, when backtracking is just stateful DFS", duration: "~2.5–3h", project: "LeetCode: Subsets, Permutations, Combinations, N-Queens, Word Search", status: "available" },
  { slug: "greedy", number: 24, phase: "Algorithmic Techniques", phaseNumber: 6, title: "Greedy algorithms", subtitle: "When greedy works (and why it fails when it doesn't), exchange-argument intuition", duration: "~1.5–2h", project: "LeetCode: Jump Game, Gas Station, Task Scheduler, Non-overlapping Intervals", status: "available" },
  { slug: "bit-manipulation", number: 25, phase: "Algorithmic Techniques", phaseNumber: 6, title: "Bit manipulation", subtitle: "The operators you forgot existed, XOR's superpowers, bitmask DP teaser", duration: "~1.5–2h", project: "LeetCode: Single Number, Number of 1 Bits, Counting Bits, Sum of Two Integers", status: "available" },
  ...
  { slug: "dp-1d", number: 27, phase: "Dynamic Programming", phaseNumber: 7, title: "1D DP patterns", subtitle: "Linear-state DP, the 'decision at index i' template", duration: "~2–2.5h", project: "LeetCode: Coin Change, Word Break, Longest Increasing Subsequence, Decode Ways", status: "available" },
  { slug: "dp-2d", number: 28, phase: "Dynamic Programming", phaseNumber: 7, title: "2D DP & grid DP", subtitle: "Two-pointer state, edit-distance family, grid path-counting", duration: "~2.5–3h", project: "LeetCode: Unique Paths, Longest Common Subsequence, Edit Distance, 0/1 Knapsack", status: "available" },
  { slug: "dp-advanced", number: 29, phase: "Dynamic Programming", phaseNumber: 7, title: "Advanced DP: intervals, trees, bitmask", subtitle: "When state isn't just an index — DP on trees, bitmask DP for subsets", duration: "~2–2.5h", project: "LeetCode: Burst Balloons, House Robber III, Partition Equal Subset Sum", status: "available" },

  // Phase 8 · Advanced & Interview Prep
  { slug: "tries", number: 30, phase: "Advanced & Interview Prep", phaseNumber: 8, title: "Tries", subtitle: "The prefix-tree structure, when a trie beats a hashmap, autocomplete intuition", duration: "~1.5–2h", project: "Build a trie + LeetCode: Implement Trie, Word Search II, Replace Words", status: "available" },
  ...
  { slug: "capstone", number: 34, phase: "Advanced & Interview Prep", phaseNumber: 8, title: "Capstone: 20-problem mixed set", subtitle: "Curated mixed-pattern problem set — pick the pattern, justify, then solve", duration: "~4–5h", project: "Portfolio-ready solutions repo with writeups", status: "available" },
];
