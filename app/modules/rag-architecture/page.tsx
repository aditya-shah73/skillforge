...
contextual-markdown-h2            18 chunks  recall@5 = 0.91`}</CodeBlock>
      ...
      <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex justify-between text-sm">
        <Link href="/modules/pgvector" className="text-slate-600 dark:text-slate-400 hover:text-emerald-600">
          ← Module 15: Vector DBs &amp; pgvector
        </Link>
        <Link href="/modules/rag-spring" className="text-emerald-600 hover:underline font-semibold">
