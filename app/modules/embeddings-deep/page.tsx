  ...
  return (
    <article className="prose-custom">
      ...
      <header className="mb-8 pb-8 border-b border-slate-200 dark:border-slate-800">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-3">Embeddings deep dive</h1>
...
./mvnw spring-boot:run`}</CodeBlock>
      ...
      <div className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex justify-between text-sm">
        ...
        <Link href="/modules/pgvector" className="text-indigo-600 hover:underline">Module 15: Vector DBs &amp; pgvector →</Link>
      </div>
    </article>
  );
}
