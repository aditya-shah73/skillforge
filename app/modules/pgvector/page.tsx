...
-- selective that brute force IS faster.`}</CodeBlock>
      ...
      <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex justify-between text-sm">
        <Link href="/modules/embeddings-deep" className="text-slate-600 dark:text-slate-400 hover:text-emerald-600">
          ← Module 14: Embeddings deep dive
        </Link>
        <Link href="/modules/rag-architecture" className="text-emerald-600 hover:underline font-semibold">
