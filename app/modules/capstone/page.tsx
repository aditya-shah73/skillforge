  ...
  return (
    <article className="prose-custom">
      ...
      <Callout variant="info" title="Prerequisites">
        Everything. You need <Link href="/modules/api-fundamentals">Module 9 (API)</Link>,{" "}
        <Link href="/modules/spring-ai">Module 10 (Spring AI)</Link>, <Link href="/modules/tool-use">Module 11 (tools)</Link>,{" "}
        <Link href="/modules/streaming">Module 12 (SSE)</Link>, <Link href="/modules/prompt-caching">Module 13 (caching)</Link>,{" "}
        <Link href="/modules/rag-spring">Module 17 (RAG in Spring)</Link>, <Link href="/modules/chat-interface">Module 19 (chat UI)</Link>,{" "}
        <Link href="/modules/agent-spring">Module 22 (agents)</Link>, <Link href="/modules/evals">Module 24 (evals)</Link>, and{" "}
        <Link href="/modules/security">Module 25 (security)</Link>. If any of those feel rusty, skim them first — we&apos;re assembling, not teaching.
      </Callout>
...
public class HybridRetriever {
    ...
    private List<Document> reciprocalRankFusion(List<Document> a, List<Document> b, int k) {
      ...
      <p>
        ...
        result feeds back, repeat. You built this in <Link href="/modules/agent-spring">Module 22</Link>. Here it&apos;s
...
public class ToolRegistry {
    ...
    // ... individual handlers below
      ...
      <p>
        Same defensible structure you learned in <Link href="/modules/security">Module 25</Link>: clear role,
        explicit rules, scope boundary, citation discipline. Cache it (<Link href="/modules/prompt-caching">Module 13</Link>) —
    ...
    return """
      ...
      <Callout variant="insight" title="Rule 4 is the security plug-in point">
        ...
        <Link href="/modules/security">Module 25</Link>, your assistant is meaningfully harder to abuse than 90% of
      ...
      <p>
        ...
        mid-response. You built every piece of this in <Link href="/modules/react-streaming">Module 18</Link> and{" "}
        <Link href="/modules/chat-interface">Module 19</Link>.
      </p>
...
{ "type": "error",             "message": "..." }`}</CodeBlock>
      ...
      <p>
        ...
        <Link href="/modules/evals">Module 24</Link> and your injection test suite from{" "}
        <Link href="/modules/security">Module 25</Link> directly into CI, gating merges.
      </p>
