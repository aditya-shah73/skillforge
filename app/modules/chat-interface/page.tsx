...
INSERT INTO tickets (code, title, team, assignee, status, shipped_at) VALUES
  ...
  ('GRO-2014', 'Pricing page redesign',   'growth', 'maya',  'in_progress', NULL);`}</CodeBlock>
      ...
      <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex justify-between text-sm">
        <Link href="/modules/react-streaming" className="text-slate-600 dark:text-slate-400 hover:text-sky-600">
          ← Module 18: React streaming patterns
        </Link>
        <Link href="/modules/multimodal" className="text-sky-600 hover:underline font-semibold">
