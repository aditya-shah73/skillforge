  ...
  return (
    <main style={{ maxWidth: 720, margin: "2rem auto", padding: "1rem" }}>
      ...
      <footer className="mt-12 pt-8 border-t border-slate-200 dark:border-slate-800 flex justify-between text-sm">
        <Link href="/modules/rag-spring" className="text-slate-600 dark:text-slate-400 hover:text-sky-600">
          ← Module 17: RAG in Spring Boot
        </Link>
        <Link href="/modules/chat-interface" className="text-sky-600 hover:underline font-semibold">
