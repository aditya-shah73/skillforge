  ...
  return (
    <article className="prose-custom">
      ...
      <Callout variant="info" title="Prerequisites">
        You should be comfortable with everything from <Link href="/modules/ml-basics">Module 2 (supervised learning)</Link>,{" "}
        <Link href="/modules/ml-training">Module 3 (training loops)</Link>, and <Link href="/modules/neural-networks">Module 4 (neural networks)</Link>.
        You should also have shipped a RAG pipeline (<Link href="/modules/rag-spring">Module 17</Link>) and tuned prompts (<Link href="/modules/prompt-engineering">Module 7</Link>) so you have something to compare against.
      </Callout>
      ...
      <p>
        We covered the mechanics in <Link href="/modules/ml-training">Module 3</Link> and{" "}
        <Link href="/modules/neural-networks">Module 4</Link>: forward pass, loss, backward pass, gradient update, repeat.
...
Real numbers for a 70B model with rank r=16:
  ...
  LoRA trainable params:     ~50,000,000   (0.07%)`}</CodeBlock>
      ...
      <p>
        Caveat: <Link href="/modules/prompt-caching">prompt caching (Module 13)</Link> often gets you the same cost
      ...
      <p>
        ...
        descriptions, missing examples, or a bug in your <Link href="/modules/agent-spring">agent loop (Module 22)</Link>.
      </p>
...
→ FINE-TUNE. Use LoRA. Compare against the base + prompt baseline. Re-evaluate quarterly.`}</CodeBlock>
      ...
      <p>
        ...
        re-run the eval. (See <Link href="/modules/evals">Module 24</Link>.) Eval cost is not a one-time investment.
      </p>
