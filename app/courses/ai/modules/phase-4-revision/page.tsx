...
flowchart LR
      ...
      <section className="not-prose mb-12">
        ...
        <div className="mb-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-emerald-200 bg-emerald-50/40 p-5 dark:border-emerald-900 dark:bg-emerald-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-700 uppercase dark:text-emerald-300">Pick <code>EventSource</code> when</div>
          ...
          <div className="rounded-xl border border-sky-200 bg-sky-50/40 p-5 dark:border-sky-900 dark:bg-sky-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Pick <code>fetch</code> stream when</div>
            <ul className="list-disc space-y-1 pl-5 text-sm text-slate-700 dark:text-slate-300">
  ...
  while (!signal.aborted) {
    try { await run(signal); return; }
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">2. Token-by-token UI rendering</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
  ...
  return { text, append };
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Streaming-cursor UX</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Scroll anchoring</div>
            <p className="text-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Memoize the list</div>
            <p className="text-sm text-slate-700 dark:text-slate-300">
...
type ToolUse = { id: string; name: string; input: unknown; output?: unknown; status: "pending" | "done" | "error" };`}</CodeBlock>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Regenerate</div>
            <p className="text-sm text-slate-700 dark:text-slate-300">
      ...
      <section className="not-prose mb-12">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 1 · <code>EventSource</code> for a chat POST</div>
...
const res = await fetch("/api/chat", {
  ...
  signal: ac.signal,
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 2 · <code>setState</code> on every token</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
...
const onToken = (t: string) => {
  ...
  rafRef.current = requestAnimationFrame(() => {
    ...
    rafRef.current = null;
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 3 · Missing <code>AbortController</code> on unmount</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
...
useEffect(() => {
  ...
  return () => ac.abort();
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 4 · Markdown lib that throws on partial input</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
