  ...
  return (
    <article className="prose-custom">
      ...
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">1. Evals cheat sheet</h2>
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-emerald-50/40 p-5 dark:border-slate-800 dark:bg-emerald-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-700 uppercase dark:text-emerald-300">Golden set</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-sky-50/40 p-5 dark:border-slate-800 dark:bg-sky-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-sky-700 uppercase dark:text-sky-300">Deterministic checks</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="rounded-xl border border-slate-200 bg-purple-50/40 p-5 dark:border-slate-800 dark:bg-purple-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-purple-700 uppercase dark:text-purple-300">LLM-as-judge</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="rounded-xl border border-slate-200 bg-amber-50/40 p-5 dark:border-slate-800 dark:bg-amber-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-amber-700 uppercase dark:text-amber-300">Regression gate in CI</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">2. LLM-as-judge — when it works, when it doesn&apos;t</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              ...
              <tr>
                ...
                <td className="px-4 py-3 font-semibold text-emerald-600">Yes — pairwise</td>
              ...
              <tr>
                ...
                <td className="px-4 py-3 font-semibold text-amber-600">Maybe</td>
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">3. The production request path</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">4. Security &amp; guardrails</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div className="mb-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Vector 1 · Direct injection</div>
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Vector 2 · Indirect (via retrieved content)</div>
            <p className="text-sm text-slate-700 dark:text-slate-300">
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Vector 3 · Tool-result poisoning</div>
            <p className="text-sm text-slate-700 dark:text-slate-300">
        ...
        <h3 className="mb-3 text-base font-semibold">The four defenses</h3>
        ...
        <h3 className="mb-3 text-base font-semibold">PII + the cost-cap pair</h3>
        <ul className="list-disc space-y-2 pl-5 text-sm text-slate-700 dark:text-slate-300">
          <li>
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">5. Fine-tune vs RAG vs prompt — the decision table</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">6. Production readiness checklist</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Evals in CI</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Structured logs with trace IDs</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Cost dashboards per route</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Fallback model for outages</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Prompt versioning</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Kill-switch for agents</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 md:col-span-2 dark:border-slate-800 dark:bg-slate-900/40">
            <div className="mb-2 text-xs font-bold tracking-wider text-emerald-600 uppercase">Human review queue for sensitive ops</div>
      ...
      {/* ============================================================ */}
      <section className="not-prose mb-12">
        <h2 className="mb-1 text-2xl font-bold tracking-tight">7. Four gotchas that ship to production</h2>
        <p className="mb-4 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 1 · Shipping without an eval set</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
...
5. Each prompt version is logged with its eval score.`}</CodeBlock>
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 2 · Retrieved content treated as instruction</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
...
// If retrievedChunk contains "Ignore previous instructions...", it works.`}</CodeBlock>
    ...
    User: """ + userQuery;`}</CodeBlock>
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 3 · Fine-tuning when RAG would have shipped</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
...
Outcome:
  ...
  - Switch base model whenever a better one ships`}</CodeBlock>
          ...
          <div className="rounded-xl border border-rose-200 bg-rose-50/40 p-5 dark:border-rose-900 dark:bg-rose-950/20">
            <div className="mb-2 text-xs font-bold tracking-wider text-rose-700 uppercase dark:text-rose-300">Gotcha 4 · No per-user cost cap</div>
            <p className="mb-3 text-sm text-slate-700 dark:text-slate-300">
