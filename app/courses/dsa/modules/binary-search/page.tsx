    ...
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <div className="not-prose mb-8">
        ...
        <div className="mt-2 block w-fit rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 px-3 py-1 text-xs font-bold tracking-wider text-white uppercase">
          Phase 6 · Module 25 · Algorithmic Techniques
        </div>
    ...
    return lo;                  // lo == hi; that's a peak
      ...
      <section>
        ...
        <div className="not-prose mt-12 rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50 p-6 dark:border-indigo-800 dark:from-indigo-950/40 dark:to-purple-950/40">
          <p className="text-xs font-semibold tracking-wider text-indigo-700 uppercase dark:text-indigo-300">Up next · Module 26</p>
          <Link
            href="/courses/dsa/modules/sorting"
            className="mt-2 inline-flex items-center gap-2 text-xl font-bold text-slate-900 no-underline hover:text-indigo-700 dark:text-slate-100 dark:hover:text-indigo-300"
          >
            Sorting algorithms →
          </Link>
          <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">Binary search needs a sorted array. Time to find out how the array gets sorted in the first place.</p>
        </div>
      </section>
      </Checkpoint>
