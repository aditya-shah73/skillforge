  ...
  return (
    <article className="prose prose-slate dark:prose-invert max-w-none">
      ...
      <div className="not-prose mb-8">
        ...
        <div className="mt-2 block w-fit rounded-full bg-gradient-to-r from-emerald-500 to-green-500 px-3 py-1 text-xs font-bold tracking-wider text-white uppercase">
...
public class HeapStress {
    public static void main(String[] args) {
      ...
      <section>
        ...
        <div className="not-prose mt-12 rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-50 p-6 dark:border-emerald-800/40 dark:from-emerald-950/30 dark:to-green-950/30">
          <h3 className="m-0 text-lg font-bold text-slate-900 dark:text-slate-100">Phase 3 complete · Hashing &amp; trees</h3>
